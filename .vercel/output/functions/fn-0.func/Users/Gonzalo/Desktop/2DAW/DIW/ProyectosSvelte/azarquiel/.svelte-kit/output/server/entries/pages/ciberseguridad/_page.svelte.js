...
const Table2_svelte_svelte_type_style_lang = "";
const css$1 = {
...
const Table2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main><div class="${"table-responsive prueba svelte-1d8aj8j"}"><table class="${"table table-dark prueba svelte-1d8aj8j"}"><thead><tr><th colspan="${"3"}" scope="${"col"}" class="${"text-center"}">Familia Profesional: Informatica y comunicaciones <br> Nivel:               Curso de Especialización. <br> Titulo:              Ciberseguridad en entornos IT</th></tr>
      ...
      <tbody class="${"text-center"}"><tr><th scope="${"row"}">5048. Asignatura1.</th>
          <td>160</td>
          <td>5</td></tr>
        <tr><th scope="${"row"}">5049. Asignatura2</th>
          <td>125</td>
          <td>4</td></tr>
        <tr><th scope="${"row"}">5050. Asignatura3</th>
          <td>95</td>
          <td>3</td></tr>
        <tr><th scope="${"row"}">5051. Asignatura4</th>
          <td>95</td>
          <td>3</td></tr>
        <tr><th scope="${"row"}">5052. Asignatura5</th>
          <td>125</td>
          <td>4</td></tr></tbody>
...
const css = {
  code: "body{margin:0;padding:0}.big.svelte-1ka6g7x{width:75%}.container-fluid.svelte-1ka6g7x{background:rgba(0, 212, 255, 0.2);background:linear-gradient(90deg, rgba(0, 212, 255, 0.2) 26%, rgba(9, 18, 172, 0.1) 90%);color:black}.prueba.svelte-1ka6g7x{color:black}.btn-pr.svelte-1ka6g7x{width:100%}.logo.svelte-1ka6g7x{display:flex;justify-content:center;align-items:center;max-width:100vw}@media(max-width: 600px){.prueba.svelte-1ka6g7x{max-width:100vw}.logo.svelte-1ka6g7x{diplay:none}}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main>${validate_component(Layout, "MainTemplate").$$render($$result, {}, {}, {
    default: () => {
      return `<div class="${"container-fluid svelte-1ka6g7x"}"><div class="${"centrar-titulo"}">${validate_component(Intro, "Intro").$$render(
        $$result,
        {
      ...
      <div class="${"prueba ms-5 me-5 svelte-1ka6g7x"}"><div class="${"row d-flex justify-content-center align-items-center flex-row"}"><div class="${"col-sm-12 col-6 d-flex justify-content-center align-items-center flex-column"}"><h5>Nuestro centro tiene actualmente varios pabellones: en los cuales
          ...
          <div class="${"col-6 d-flex justify-content-center align-items-center logo svelte-1ka6g7x"}"><img class="${"big svelte-1ka6g7x"}" src="${"../../img/logoiesa.png"}" alt="${"logo del azarquiel"}"></div></div>
          ${validate_component(Table2, "Table2").$$render($$result, {}, {}, {})}
        ...
        <div class="${"d-flex justify-content-center align-items-start flex-column ps-5 pe-5 me-5 ms-5"}"><div class="${"accordion btn-pr pb-5 svelte-1ka6g7x"}" id="${"accordion1"}"><div class="${"accordion-item"}"><h2 class="${"accordion-header"}" id="${"heading1"}"><button class="${"accordion-button"}" type="${"button"}" data-bs-toggle="${"collapse"}" data-bs-target="${"#collapse1"}" aria-expanded="${"false"}" aria-controls="${"collapse1"}">¿QUIÉN PUEDE ACCEDER A ESTAS ENSEÑANZAS?
                </button></h2>
          ...
          <div class="${"accordion btn-pr pb-5 svelte-1ka6g7x"}" id="${"accordion2"}"><div class="${"accordion-item"}"><h2 class="${"accordion-header"}" id="${"heading2"}"><button class="${"accordion-button"}" type="${"button"}" data-bs-toggle="${"collapse"}" data-bs-target="${"#collapse2"}" aria-expanded="${"false"}" aria-controls="${"collapse2"}">¿PARA QUÉ SIRVE EN EL MUNDO LABORAL?
                </button></h2>
